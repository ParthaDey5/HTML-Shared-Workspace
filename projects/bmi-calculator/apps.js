...
const outputInfoContainer = document.querySelector(".output-info-container");
...
window.onload = function() {
  ...
  outputInfoContainer.style.display = "none";
}
...
function calcBmiMetric() {
  ...
  // Show welcome if inputs are empty
  ...
  outputInfoContainer.style.display = "flex";
...
function calcBmiImperial() {
  ...
  // Show welcome if inputs are empty
  if (!heightInTotal || !weightLbsTotal) {
    welcomeContainer.style.display = "flex";
    outputInfoContainer.style.display = "none";
    return;
  }
